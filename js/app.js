...
form['form__input'].addEventListener('input', () => {
    const inputValue = from['form__input'].value.toLocaleLowerCase
    const name = document.querySelectorAll('.user__name ')
    name.forEach((item) => {
        if (item.lastChild.textContent.toLowerCase().includes(inputValue)) {
...
<div class="user__location">
  ...
  <span>- ${location.citi} ${location.country}</span>
</div>
